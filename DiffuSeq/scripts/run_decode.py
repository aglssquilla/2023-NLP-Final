...
if __name__ == '__main__':
    ...
    os.chdir(dname)
    print(glob.glob("/media/disk1/minha/DiffuSeq/diffusion_models/diffuseq_nq_h128_lr0.0001_t2000_sqrt_lossaware_seed102_nq20230508-02:48:52"))
    output_lst = []
    for lst in glob.glob("/media/disk1/minha/DiffuSeq/diffusion_models/diffuseq_nq_h128_lr0.0001_t2000_sqrt_lossaware_seed102_nq20230508-02:48:52"):
        print(lst)
