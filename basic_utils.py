...
class Modified_myTokenizer():
    ...
    def encode_token(self, sentences):
        ...
        # Noise 토큰을 랜덤하게 생성한다
        noise_token_id = len(self.tokenizer) + 1
        for ids in input_ids:
            noise_id = random.randint(4, len(ids)-1)  # input sequence에서 랜덤하게 poistion을 선택한다
            ids.insert(noise_id, noise_token_id)
